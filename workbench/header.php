...
<html>
    <head>
        ...
        print "<title>Workbench by JMC$title</title>";
...
<div id='navMenu' style="clear: both;">
    ...
    foreach ($GLOBALS["MENUS"] as $menu => $pages) {
        ...
        $menuLabel = ($menu == "WORKBENCH by JMC") ? "&nbsp;<img src='" . getPathToStaticResource('/images/workbench-3-cubed-white-small.png') . "'/>" : strtolower($menu);
